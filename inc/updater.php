 ...
 * Access https://unitone.2inc.org/wp-json/unitone-license-manager/v1/update/...?repository=unitone-bbpress-integrator
...
add_filter(
	...
	function ( $url, $user_name, $repository, $version ) {
		return add_query_arg(
			array(
				'repository' => 'unitone-bbpress-integrator',
...
add_filter(
	...
	function ( $args, $url, $user_name, $repository ) {
		if ( 'inc2734' !== $user_name || 'unitone-bbpress-integrator' !== $repository ) {
			return $args;
		}
